        ...
        <div class="user-main-container">
            <div class="slider">
                <div class="slide">
                    ...
                    <div class="guide">
                        <h6><strong><span class="text-primary">(1)</span></strong> Select Cashier to continue and click “Next”.</h6>
                    </div>
                </div>
                <div class="slide">
                    <img src="../../img/user_manual/step9.png" alt="Step 2">
                    <div class="guide">
                        <h6><strong><span class="text-primary">(2)</span></strong> Enter the Email Address and Password of the Cashier and click then “Sign In” to access the system.</h6>
                    </div>
                </div>
                <div class="slide">
                    <img src="../../img/user_manual/step10.png" alt="Step 3">
                    <div class="guide">
                        <h6>
                            <strong><span class="text-primary">(3)</span></strong> Always click the categories to view various products. <br>
                            <strong><span class="text-primary">(4)</span></strong> Use “Search bar” to search for specific products.<br>
                            <strong><span class="text-primary">(5)</span></strong> Click “Proceed to payment” button to continue. Select payment method and enter the amount and then print invoice.<br>
                        </h6>
                    </div>
                </div>
                <div class="slide">
                    <img src="../../img/user_manual/step11.png" alt="Step 4">
                    <div class="guide">
                        <h6>
                            <strong><span class="text-primary">(6)</span></strong> Click “Approve” button to approved the order or click “Disapprove” to disapproved order.<br>
                            <strong><span class="text-primary">(7)</span></strong> Use “Search bar” to search for specific customer.<br>
                            <strong><span class="text-primary">(8)</span></strong> Click “Export to Excel” button to generate report.<br>
                        </h6>
                    </div>
                </div>
                <div class="slide">
                    <img src="../../img/user_manual/step12.png" alt="Step 5">
                    <div class="guide">
                        <h6>
                            <strong><span class="text-primary">(9)</span></strong> Click any buttons at the top and it will display the orders of different environment.<br>
                            <strong><span class="text-primary">(10)</span></strong> Click “View” button to display the orders.<br>
                            <strong><span class="text-primary">(11)</span></strong> Click “Print Invoice” to finish.
                        </h6>
                    </div>
                </div>
                <div class="slide">
                    <img src="../../img/user_manual/step13.png" alt="Step 6">
                    <div class="guide">
                        <h6>
                            <strong><span class="text-primary">(12)</span></strong> Click customer and it will display the reason why the order has been disapproved.<br>
                        </h6>
                    </div>
                </div>
                <div class="slide">
                    <img src="../../img/user_manual/step14.png" alt="Step 7">
                    <div class="guide">
                        <h6>
                            <strong><span class="text-primary">(13)</span></strong> Click Stock Status buttons at the top to display the products ordered list of different categories. <br>
                        </h6>
                    </div>
                </div>
                <div class="slide">
                    <img src="../../img/user_manual/step15.png" alt="Step 8">
                    <div class="guide">
                        <h6>
